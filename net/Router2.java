...
public class Router2 extends Node {
    ...
    Router2(int port) {
        try {
            ...
            IPlist.add("192.20.2.255");
            IPlist.add("192.19.1.255");
        ...
        try {
            ...
            if (content.getType() == PacketContent.FILEINFO) {
                ...
                if (packet_type.equals("rout")) {
                    ...
                    dstAddress = new InetSocketAddress(previous, 50001); // if exist dst in this subnet,send the message
    ...
    public static void main(String[] args) {
        try {
            (new Router2(DEFAULT_PORT)).start();
